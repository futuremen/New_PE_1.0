...
<body>
 ...
 <div class="main">
  <a href="insertStudent" style="margin-right:10%;"><img src="images/bian.png">&nbsp;&nbsp;添加</a> 
<div class="row">
<div class="col-sm-12 col-md-12 col-lg-12" style="margin-left:-15;margin-right:-15;">
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover" style="font-size:12px;">
            ...
            <tbody>
            <c:forEach items="${classes}" var="studentClass" varStatus="sta">
            ...
            <c:set var="id" value="${studentClass.institute_id}"></c:set>
                ...
                <td>
                    <a href="StudentDetil?class_id=${studentClass.id}" style="margin-right:10%;"><img src="images/bian.png">&nbsp;&nbsp;查看班级所有学生</a>     
