     ...
     <div class="container">
       <div class="row">
        <div class="col-md-8 col-md-offset-2  col-xs-8 col-xs-offset-2   col-lg-8 col-lg-offset-2 ">
             <br>
            <form id="MyForm" class="form-horizontal" action="insertStudent" method="post">
             <br>
                ...
                <hr>-->
                 <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" name="studentAccount" class="form-control" placeholder="学号">
                    </div>
                  </div>
                    ...
                    <div class="col-sm-7">
                      <input type="text" name="tel" class="form-control" placeholder="学号">
                    </div>
                  </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" name="idcard" class="form-control" placeholder="学号">
                    </div>
                  </div>
