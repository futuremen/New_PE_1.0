    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover" style="font-size:12px;">
            ...
            <c:forEach items="${students}" var="student" varStatus="sta">
                ...
                <td>${fns:getOneStudentClass(student.class_id).name}</td>
                <td>
                    <a href="updateStudent?student_id=${student.id}" style="margin-right:10%;"><img src="images/bian.png">&nbsp;&nbsp;编辑</a>     
                    <a href="deleteStudent?student_id=${student.id}" class="tablelink1"><img src="images/shan.png">&nbsp;&nbsp;删除</a>
                </td>
                </tr>
               </c:forEach>
            </tbody>
