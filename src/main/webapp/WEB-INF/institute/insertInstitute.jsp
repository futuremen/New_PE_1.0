     ...
     <div class="container">
       <div class="row">
        <div class="col-md-8 col-md-offset-2  col-xs-8 col-xs-offset-2   col-lg-8 col-lg-offset-2 ">
             <br>
            <form id="MyForm"   class="form-horizontal" action="insertInstitute" method="post"  accept-charset="UTF-8">
             <br>
             
              <input name="id" type="hidden" value="${institute.id }">
             	<!--<div style="border-left:#3399FF solid 2px; padding:10px;"><h4>修改人员信息</h4></div>
                <hr>-->
                 <div class="form-group">
                    <label  for=""  class="col-sm-3 control-label"> 学院编号</label>
                    <div class="col-sm-7">
                      <input name="instituteNumber" type="text" class="form-control" value="${institute.instituteNumber }" >
                    </div>
                  </div>	
              
              	<div class="form-group">
                    <label for="" class="col-sm-3 control-label">学院名称 </label>
                    <div class="col-sm-7">
                      <input name="instituteName" type="text" class="form-control" value="${institute.instituteName }">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="" class="col-sm-3 control-label">学院备注信息</label>
                    <div class="col-sm-7">
                      <input name="instituteRemarks" type="text" class="form-control"  value="${institute.instituteRemarks }">
                    </div>
                  </div>
