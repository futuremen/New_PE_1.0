...
<div class="col-sm-12 col-md-12 col-lg-12" style="margin-left:-15;margin-right:-15;">
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover" style="font-size:12px;">
            ...
            <tbody>
            <c:forEach items="${fns:getAllInstitute(null)}" var="institute" varStatus="sta">
                <tr>
                <td>${sta.count }</td>
                <td>${institute.instituteNumber }</td>
                <td>${institute.instituteName }</td>
                <td>${institute.instituteRemarks }</td>
                <td>
                    <a href="updateInstitute?institute_id=${institute.id}" style="margin-right:10%;"><img src="images/bian.png">&nbsp;&nbsp;编辑</a>     
                    <a href="deleteInstitute?institute_id=${institute.id}" class="tablelink1"><img src="images/shan.png">&nbsp;&nbsp;删除</a>
                </td>
                </tr>
               </c:forEach>
            </tbody>
