...
<body>
 ...
 <div class="main">
  <a href="insertTerm" style="margin-right:10%;"><img src="images/bian.png">&nbsp;&nbsp;添加</a> 
<div class="row">
<div class="col-sm-12 col-md-12 col-lg-12" style="margin-left:-15;margin-right:-15;">
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover" style="font-size:12px;">
            ...
            <tbody>
            <c:forEach items="${fns:getAllTerm()}" var="term" varStatus="sta">
                <tr>
                <td>${sta.count }</td>
                <td>${term.mark }</td>
                
                <td>
                    <a href="updateTerm?term_id=${term.id}" style="margin-right:10%;"><img src="images/bian.png">&nbsp;&nbsp;编辑</a>     
                    <a href="deleteTerm?term_id=${term.id}" class="tablelink1"><img src="images/shan.png">&nbsp;&nbsp;删除</a>
                </td>
                </tr>
               </c:forEach>
            </tbody>
