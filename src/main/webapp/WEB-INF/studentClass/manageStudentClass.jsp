...
<body>
 ...
 <div class="main">
  <a href="insertStudentClass" style="margin-right:10%;"><img src="images/bian.png">&nbsp;&nbsp;添加</a> 
<div class="row">
<div class="col-sm-12 col-md-12 col-lg-12" style="margin-left:-15;margin-right:-15;">
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover" style="font-size:12px;">
            ...
            <tbody>
            <c:forEach items="${fns:getAllClass()}" var="studentClass" varStatus="sta">
          
           
            <c:set var="id" value="${studentClass.institute_id}"></c:set>
                ...
                <td>${studentClass.major }</td>
                <td>${fns:getInstituteItem(id).instituteName}</td>
                <td>
                    <a href="updateStudentClass?studentClass_id=${studentClass.id}" style="margin-right:10%;"><img src="images/bian.png">&nbsp;&nbsp;编辑</a>     
                    <a href="deleteStudentClass?studentClass_id=${studentClass.id}" class="tablelink1"><img src="images/shan.png">&nbsp;&nbsp;删除</a>
                </td>
                </tr>
               </c:forEach>
            </tbody>
