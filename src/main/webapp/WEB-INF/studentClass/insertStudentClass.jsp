     ...
     <div class="container">
       <div class="row">
        <div class="col-md-8 col-md-offset-2  col-xs-8 col-xs-offset-2   col-lg-8 col-lg-offset-2 ">
             <br>
            <form id="MyForm" class="form-horizontal" action="insertStudentClass" method="post">
             <br>
             	<!--<div style="border-left:#3399FF solid 2px; padding:10px;"><h4>修改人员信息</h4></div>
                <hr>-->
                 <div class="form-group">
                    <label for="" class="col-sm-3 control-label"> 班级编号</label>
                    <div class="col-sm-7">
                      <input type="text" name="number"  class="form-control" placeholder="姓名">
                    </div>
                  </div>	
                    <div class="form-group">
              	...
              	<div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" name="major" class="form-control" placeholder="电话">
                    </div>
                  </div>
